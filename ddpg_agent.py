...
from model_u import Actor, Critic
import torch
...
class Agent:
    def __init__(self, num_agents, state_size, action_size, random_seed,
        ...
        Args:
            num_agents (TYPE): number of agents from the environment
            ...
            update_num_repeats (int, optional): how many time to sample the replay buffer and update networks each learning step
        ...
        # Noise process
        self.noise = OUNoise(num_agents, action_size, random_seed, decay=noise_decay)
